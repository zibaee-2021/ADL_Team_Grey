...
preproc = T.Compose([
    ...
    T.ToDtype(torch.float32, scale=True),  # to float32 in [0, 1]
    T.Normalize(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)),  # typically from ImageNet
])
...
out = T.CutMix(num_classes=NUM_CLASSES, labels_getter=labels_getter)(batch)
