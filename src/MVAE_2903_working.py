...
if __name__ == '__main__':
    ...
    if run_pretraining: # Run training
        ...
        for epoch in range(pt_num_epochs):
            ...
            for its, (input_images, input_labels) in enumerate(dataloader):
                ...
                outputs = output_tensors.view(pt_batch_size, parameters['num_channels'], parameters['image_size'], parameters['image_size']) # put this into class
    ...
    if check_infilling:
        ...
        with torch.no_grad():
            ...
            infill_image_tensor = infill_image_tensor.reshape(parameters['num_channels'], parameters['image_size'], parameters['image_size'])
    ...
    # load data
    train_loader, val_loader, test_loader = OxfordDataset(script_dir+oxford_dir, train_size, val_size, test_size, ft_batch_size)
    # Initialize model
