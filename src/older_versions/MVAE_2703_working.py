...
""" Stephen 27.03.24 email
Here is a working version of the Masked Auto-Encoder code. 
There’s a bit of cleaning up to do, and I’ll build in an inference function to test whether it’s working, 
then I think this part is done, except for deciding on the network parameters.
"""
